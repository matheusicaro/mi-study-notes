...
```typescript
/**
 * 2. Once we have defined our objects we have to create a common interface for them.
 * All of my objects will have the function render.
 */
interface Component {
  render: () => void;
}
...
/**
 * 3. Now we have to create the classes of the different objects defined in the first step.
 * These classes have to implement the interface we just defined.
 */
